...
const server = await startPostgresServer({ dataDir: path.join(root, 'var/postgres'), port, persistent: true });
...
console.log(`PostgreSQL (embedded) ready: DATABASE_URL=postgresql://postgres:postgres@127.0.0.1:${port}/jamzo`);
