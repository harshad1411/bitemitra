...
export const PERMISSIONS = [
  ...
  {
    key: 'config.manage',
    description: 'Change settings, app version policies and maintenance mode',
    phase: 1,
  },
  ...
  { key: 'restaurants.view', description: 'View restaurants', phase: 2 },
  {
    ...
    description: 'Edit restaurants, hours, documents; pause restaurants',
    phase: 2,
  },
  {
    key: 'restaurants.approve',
    description: 'Approve and activate restaurants; verify bank details',
    phase: 2,
  },
  ...
  {
    key: 'pricing.manage',
    description: 'Change markup, delivery, platform fee and small-order rules',
    phase: 4,
  },
