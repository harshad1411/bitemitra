...
describe('feature flags', () => {
  ...
  it('targets apps, cities and minimum app versions', () => {
    const flag = { key: 'tips', enabled: true, rules: { apps: ['CUSTOMER'], cityIds: ['unjha'], minAppVersion: '1.4.0' } };
  ...
  it('percentage rollout is stable per user and roughly proportional', () => {
    ...
    const on = Array.from({ length: 10_000 }, (_, i) => evaluateFlag(flag, { userId: `user-${i}` })).filter(Boolean).length;
