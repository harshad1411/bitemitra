...
| `settlements.view`, `settlements.manage`, `ledgers.adjust` | view settlements, ledgers, cash deposits, Finance checks; run / approve / record payouts, verify deposits; manual ledger adjustments | 8 |
