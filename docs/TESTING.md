...
| Mobile foundations & screens | Jest-Expo + React Native Testing Library | gates, login flow, shells, error/loading states; customer: location → home → menu → customise → cart bill → coupon, sign-in when needed, denied location, unpublished pages | yes |
